...
== https://www.youtube.com/watch?v=vrry-I4NXCI[Talk by Gordon Force about BDD at the San Francisco Java User Group] footnote:[Helm, C. (2013). Behavior Driven Development with Cucumber.]
===== Video Link _59:21_ ►
