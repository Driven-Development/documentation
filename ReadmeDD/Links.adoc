...
► Implications and benefits of having a README and its links to a design-driven way of thinking, as well as how it fits into https://github.com/Driven-Development/documentation/blob/master/DocumentationDD/Links.adoc[Documentation Driven Development] and others.
...
* README is an introduction to the code rather than a whole documentation
...
* An over-generlization of a good idea, and need to fit into the documentation process of the project.
...
* Helps the reader identify the project.  ○ Evaluate the project - who it's for/ help, where it came from.  ○ Use the project one time.  ○ Help the reader engage with the project.
...
* Name prerequisites  ○ List installation steps  ○ Show it works once.
