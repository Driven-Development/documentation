...
► Delving straight into writing code is not a good idea in the long term. _0:29_

► The proper software process _3:46_

- ► Tests and Test-Driven Development _4:46_
...
► Wwhat is test-driven development?- With an example.
